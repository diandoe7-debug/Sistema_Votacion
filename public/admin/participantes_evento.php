...
<head>
    ...
    <style>
        ...
        * {
        ...
        tr:hover .participante-nombre::after {
            width: 100%;
        }

        body.day-mode .participante-nombre {
            color: var(--text-day); /* NEGRO en modo día */
        }
        ...
        body.day-mode .foto-container {
            background: var(--glass-bg-day);
            border: 2px solid var(--glass-border-day);
        }
        ...
        .participante-foto:hover .foto-preview {
            transform: scale(1.1);
        }
        ...
        body.day-mode .descripcion-text {
            color: var(--text-day);
        }
...
<body class="night-mode">
    ...
    <div class="container">
        <div class="header">
            ...
            <p class="info-text">Lista de concursantes inscritos en este evento</p>
        </div>
        ...
        <?php if ($evento): ?>
            ...
            <div class="actions-grid">
                ...
                <a href="participantes.php" class="btn btn-success interactive-element">
                    ...
                    <tbody>
                        <?php if (empty($participantes)): ?>
                            <tr>
                                <td colspan="6" class="no-data info-text">
                                    ...
                                    <a href="participantes.php" class="btn btn-success interactive-element" style="margin-top: 15px;">
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="foto-container participante-foto interactive-element" 
                                ...
                                <td class="info-text">
                                    <span class="edad-badge interactive-element">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Efectos en badges de edad
            var edadBadges = document.querySelectorAll('.edad-badge');
            for (var j = 0; j < edadBadges.length; j++) {
                edadBadges[j].addEventListener('mouseenter', function() {
                    this.style.transform = 'scale(1.2) rotate(10deg)';
                });
                edadBadges[j].addEventListener('mouseleave', function() {
